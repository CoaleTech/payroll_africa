...
def get_columns():
	return [
		...
		{"fieldname":"sshfc_emp", "label":_("SSHFC Employee"), "fieldtype":"Currency", "width":130},
		{"fieldname":"sshfc_empr", "label":_("SSHFC Employer"), "fieldtype":"Currency", "width":130},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ['SSHFC Employee', 'SSHFC Employer'])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["sshfc_emp"] = slip_amounts.get("SSHFC Employee", 0)
		row["sshfc_empr"] = slip_amounts.get("SSHFC Employer", 0)
		del row["salary_slip"]
