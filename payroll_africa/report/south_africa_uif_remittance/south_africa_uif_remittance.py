...
def get_columns():
	return [
		...
		{"fieldname": "uif_employee", "label": _("UIF Employee"), "fieldtype": "Currency", "width": 140},
		{"fieldname": "uif_employer", "label": _("UIF Employer"), "fieldtype": "Currency", "width": 140},
		{"fieldname": "sdl", "label": _("SDL"), "fieldtype": "Currency", "width": 120},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ["UIF Employee", "UIF Employer", "SDL"])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["uif_employee"] = slip_amounts.get("UIF Employee", 0)
		row["uif_employer"] = slip_amounts.get("UIF Employer", 0)
