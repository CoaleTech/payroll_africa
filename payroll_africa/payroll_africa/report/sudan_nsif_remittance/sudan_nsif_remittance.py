...
def get_columns():
	return [
		...
		{"fieldname":"nsif_emp", "label":_("NSIF Employee"), "fieldtype":"Currency", "width":130},
		{"fieldname":"nsif_empr", "label":_("NSIF Employer"), "fieldtype":"Currency", "width":130},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ['NSIF Employee', 'NSIF Employer'])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["nsif_emp"] = slip_amounts.get("NSIF Employee", 0)
		row["nsif_empr"] = slip_amounts.get("NSIF Employer", 0)
		del row["salary_slip"]
