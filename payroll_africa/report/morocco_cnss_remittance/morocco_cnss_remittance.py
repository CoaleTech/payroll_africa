...
def get_columns():
	return [
		...
		{"fieldname": "cnss_employee", "label": _("CNSS Employee"), "fieldtype": "Currency", "width": 150},
		{"fieldname": "cnss_employer", "label": _("CNSS Employer"), "fieldtype": "Currency", "width": 150},
	]
...
def get_data(filters):
	...
	for row in data:
		...
		row["cnss_employer"] = slip_amounts.get("CNSS Employer", 0)
