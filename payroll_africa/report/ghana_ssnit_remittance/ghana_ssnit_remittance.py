...
def get_columns():
	return [
		...
		{"fieldname": "ssnit_employee", "label": _("SSNIT Employee"), "fieldtype": "Currency", "width": 150},
		{"fieldname": "ssnit_employer", "label": _("SSNIT Employer"), "fieldtype": "Currency", "width": 150},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ["SSNIT Employee", "SSNIT Employer"])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["ssnit_employee"] = slip_amounts.get("SSNIT Employee", 0)
		row["ssnit_employer"] = slip_amounts.get("SSNIT Employer", 0)
