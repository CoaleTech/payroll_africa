...
def get_columns():
	return [
		...
		{"fieldname":"cnas_employee", "label":_("CNAS Employee"), "fieldtype":"Currency", "width":130},
		{"fieldname":"cnas_employer", "label":_("CNAS Employer"), "fieldtype":"Currency", "width":130},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ['CNAS Employee', 'CNAS Employer'])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["cnas_employee"] = slip_amounts.get("CNAS Employee", 0)
		row["cnas_employer"] = slip_amounts.get("CNAS Employer", 0)
		del row["salary_slip"]
