...
def get_columns():
	return [
		...
		{"fieldname":"nassit_emp", "label":_("NASSIT Employee"), "fieldtype":"Currency", "width":130},
		{"fieldname":"nassit_empr", "label":_("NASSIT Employer"), "fieldtype":"Currency", "width":130},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ['NASSIT Employee', 'NASSIT Employer'])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["nassit_emp"] = slip_amounts.get("NASSIT Employee", 0)
		row["nassit_empr"] = slip_amounts.get("NASSIT Employer", 0)
		del row["salary_slip"]
