...
def get_columns():
	return [
		...
		{"fieldname":"social_empr", "label":_("Social Security Employer"), "fieldtype":"Currency", "width":130},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ['PAYE', 'Social Security Employer'])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["paye"] = slip_amounts.get("PAYE", 0)
		row["social_empr"] = slip_amounts.get("Social Security Employer", 0)
		del row["salary_slip"]
