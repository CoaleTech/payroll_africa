...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ["NSSF Employee TZ", "NSSF Employer TZ"])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		emp = slip_amounts.get("NSSF Employee TZ", 0)
		empr = slip_amounts.get("NSSF Employer TZ", 0)
