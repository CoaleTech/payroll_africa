...
def get_columns():
	return [
		...
		{"fieldname":"inps_emp", "label":_("INPS Employee"), "fieldtype":"Currency", "width":130},
		{"fieldname":"inps_empr", "label":_("INPS Employer"), "fieldtype":"Currency", "width":130},
	]
...
def get_data(filters):
	...
	amounts = fetch_component_amounts(slip_names, ['INPS Employee', 'INPS Employer'])

	for row in data:
		slip_amounts = amounts.get(row.salary_slip, {})
		row["inps_emp"] = slip_amounts.get("INPS Employee", 0)
		row["inps_empr"] = slip_amounts.get("INPS Employer", 0)
		del row["salary_slip"]
